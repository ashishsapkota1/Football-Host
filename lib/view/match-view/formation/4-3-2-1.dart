...
class FormationNo4 extends StatelessWidget {
  final int quarterTurn;
  const FormationNo4({super.key, required this.quarterTurn});
            ...
            child: RotatedBox(
              ...
              child: Stack(
                children: [
                        ...
                        Stack(
                          children: [
                            ...
                            Positioned(
                                ...
                                top: Responsive.screenHeight(context)*0.08,
                                child: CircleAvatar()),
                            Positioned(
                  ...
                  Positioned(
                      left: Responsive.screenWidth(context)*0.12,
                      top: Responsive.screenHeight(context)*0.16,
                      child: CircleAvatar()),
                  Positioned(
                      left: Responsive.screenWidth(context)*0.44,
                      top: Responsive.screenHeight(context)*0.16,
                      child: CircleAvatar()),
                  Positioned(
                      left: Responsive.screenWidth(context)*0.78,
                      top: Responsive.screenHeight(context)*0.16,
                      child: CircleAvatar()),
                  Positioned(
                      left: Responsive.screenWidth(context)*0.23,
                      top: Responsive.screenHeight(context)*0.23,
                      child: CircleAvatar()),
                  Positioned(
                      left: Responsive.screenWidth(context)*0.63,
                      top: Responsive.screenHeight(context)*0.23,
                      child: CircleAvatar()),
                  Positioned(
